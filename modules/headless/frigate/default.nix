...
let
  ...
  # https://github.com/blakeblackshear/frigate/blob/v0.13.2/docker/main/Dockerfile#L96-L97
  ...
  # OpenVino models
  # https://github.com/blakeblackshear/frigate/blob/v0.13.2/docker/main/Dockerfile#L101
...
python.pkgs.buildPythonApplication rec {
  ...
  postPatch = ''
    ...
    echo "SANDER: pwd:$PWD out:$out phout:${placeholder "out"}" 

    ls -lai frigate/events 
  ...
  installPhase = ''
    ...
    echo "SANDER: preInstall: $out/${python.sitePackages}/frigate/" 
    ...
    cp audio-labelmap.txt $out/share/frigate/
